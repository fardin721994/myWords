let data = [
  ...
  {
    word: "mess around",
    pronunciation: "/ˈmes əˌraʊnd/",
    frequency: {},
    partOfSpeech: "phrasal verb",
    register: "informal",
    additionalData: "(also mess about British English)",
    meanings: [
      {
        index: "1",
        definition:
          "to spend time lazily, doing things slowly and in a way that is not planned",
        examples: ["He spent his vacation messing around on the farm."],
      },
      {
        index: "2",
        definition:
          "to behave in a silly way when you should be paying attention or doing something sensible SYN fool around",
        examples: ["Stop messing around and get ready for school."],
      },
      {
        index: "3",
        definition:
          "mess somebody around, to cause a lot of problems for someone, especially by changing your mind often and not being completely honest",
        examples: ["Don’t mess me around – I want the money you promised me."],
      },
    ],
  },
  {
...
const json = JSON.stringify(test2);
