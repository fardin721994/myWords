let data = [
...

  {
    ...
    meanings: [
      ...
      },
      {
        index: "2",
        definition:
          "if someone shakes, or part of their body shakes, they make small sudden movements from side to side or up and down, especially because they are very frightened, cold, ill etc SYN tremble",
        examples: [
      ...
      },
      {
        index: "3",
        definition:
          "→ shake your head, to move your head from side to side as a way of saying no, or to show disapproval, surprise, or sadness",
        examples: [
      ...
      },
      {
        index: "4",
        definition:
          "→ shake somebody’s hand/shake hands with somebody, to move someone’s hand up and down with your own hand as a greeting or as a sign you have agreed something",
        examples: [
      ...
      {
        index: "5",
        definition: "to make someone feel very upset or shocked",
        examples: [
      ...
      },
      {
        index: "6",
        definition:
          "→ shake somebody’s confidence/beliefs etc, to make someone feel less confident, less sure about their beliefs etc",
        examples: ["His confidence was badly shaken."],
      },
      {
        index: "7",
        definition:
          "→ somebody’s voice shakes, if someone’s voice is shaking, it is not steady and they sound very worried, angry, or frightened",
        examples: [
      ...
      },
      {
        ...
        examples: ["He shook his fist at the driver of the other car."],
      },
      {
        index: "9",
        definition:
          "→ shake a leg, spoken, used to tell someone to hurry, or quickly start doing something",
        examples: ["C’mon, shake a leg!"],
      },
    ],
  },
  {
  ...
  {
    word: "maid of honor",
    pronunciation: "/ˌmeɪd əv ˈɒnə $ -ər/",
    frequency: {},
    partOfSpeech: "noun",
    register: "",
    additionalInfo:
    ...
    meanings: [
      {
        index: "1",
        definition: "the most important bridesmaid at a wedding",
        examples: [],
      },
      {
        index: "2",
        definition: "an unmarried woman who works for a queen or a princess",
        examples: [],
      },
    ],
  },
  ...
  },
  {
    ...
    partOfSpeech: "verb",
    register: "",
    additionalInfo: "(past tense and past participle stuck /stʌk/)",
    meanings: [
      {
        index: "1",
        definition:
      ...
      },
      {
        index: "3",
        definition:
          "informal, to put something somewhere quickly and without much care SYN bung",
        examples: [
      ...
      },
      {
        index: "4",
        definition:
          " if you stick a part of your body somewhere, you put it in a position where other people can see it SYN put",
        examples: [
      ...
      },
      {
        index: "6",
        definition:
          "→ stick in somebody’s mind, if something sticks in your mind, you remember it well because it is unusual or interesting",
        examples: ["It’s the kind of name that sticks in your mind."],
      },
      {
        index: "7",
        definition:
          "→ make something stick, informal, a) to prove that something is true b) to make a change become permanent",
        examples: [
